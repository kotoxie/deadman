...
import EncryptionKeyWarningBanner from '../ui/EncryptionKeyWarningBanner.jsx';
...
export default function AppLayout() {
  const { logout, encryptionKeyAutoGenerated } = useAuth();
  ...
  return (
    <div className="flex h-screen">
      ...
      <main className="flex-1 overflow-y-auto">
        {encryptionKeyAutoGenerated && <EncryptionKeyWarningBanner />}
        <div className="p-6">
          <Outlet />
        </div>
      </main>
